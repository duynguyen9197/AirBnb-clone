          ...
          <div className="flex flex-row flex-grow items-center px-5">
            <div className="flex flex-row flex-grow">
              <NavLink to="/">
                <img
                  className={
                    logo
                      ? "logo active w-28 h-20"
                      : "w-28 h-20 filter brightness-0 invert"
                  }
            ...
            <div className="flex flex-row items-center justify-center flex-grow relative">
              <>
                {showSearch ? (
                  <div>
                    <input
                      className="outline-none border-2 border-gray-200 rounded-full h-12 w-64 md:w-64 lg:w-64 xl:w-64 pl-4 placeholder-black shadow-sm cursor-pointer"
                      type="text"
                  ...
                  <div>
                    <span className="text-white px-3 cursor-pointer hover:bg-gray-200 hover:text-black rounded-full p-2 cursor-pointer">
                      Place to stay
                    </span>
                    <span className="text-white px-3 cursor-pointer hover:bg-gray-200 hover:text-black rounded-full p-2 cursor-pointer">
                      Experiences
            ...
            <div className="flex flex-row items-center space-x-3 hidden md:inline-flex lg:inline-flex xl:inline-flex">
              <span
                className={
                  hostText
                    ? "text-black text-sm hover:bg-gray-300 rounded-full p-2 cursor-pointer"
                    : "text-gray-100 text-sm hover:bg-gray-300 rounded-full p-2 cursor-pointer hover:text-gray-900"
                }
              >
                Become a host
              </span>
              <LanguageIcon
                className={
                  languageIcon
                    ? "text-black cursor-pointer languageIcon"
                    : "text-gray-100 languageIcon  cursor-pointer"
                }
              />
